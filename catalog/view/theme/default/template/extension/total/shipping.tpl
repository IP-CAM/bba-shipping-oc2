    ...
    <div class="panel-body">
      ...
      <div class="form-horizontal">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="input-bbastate"><?php echo $entry_state; ?></label>
          <div class="col-sm-10">
            <select name="bbastate" id="input-bbastate" class="form-control" style="width: 100%;">
            </select>
          </div>
        </div>
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="input-bbapostcode"><?php echo $entry_postcode; ?></label>
          <div class="col-sm-10">
            <select name="bbapostcode" id="input-bbapostcode" class="form-control" style="width: 100%;">
            </select>
          </div>
        </div>
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <select name="bbacity" id="input-bbacity" class="form-control" style="width: 100%;">
            </select>
          </div>
        </div>
        <script type="text/javascript">
        var BBALogistics_Address_Field = BBALogistics_Address_Form.field();
        var field = new BBALogistics_Address_Field( "#input-bbacountry", "#input-bbastate", "#input-bbapostcode", "#input-bbacity" );
        // To add initial values
        <?php if (isset($bbacountry) && isset($bbapostcode) && isset($bbacity)) { ?>
          field.value({ country: "<?php echo $bbacountry;?>", state: "<?php echo $bbastate;?>", postcode: "<?php echo $bbapostcode;?>", city: "<?php echo $bbacity;?>" });
        <?php } ?>
        var address = new BBALogistics_Address_Form( field );
            address.init({ ajaxUrl: "index.php?route=api/bbashipping/addressapi" });
        </script>
